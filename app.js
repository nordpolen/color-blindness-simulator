...
function applyFilter() {
  ...
  ctxOriginal.drawImage(image, 0, 0, elements.canvas.width, elements.canvas.height);
...
function openModal(sourceCanvas) {
  ...
  elements.modalCanvas.width = sourceCanvas.width * 2;
  elements.modalCanvas.height = sourceCanvas.height * 2;
  modalCtx.imageSmoothingEnabled = false;
  modalCtx.drawImage(sourceCanvas, 0, 0, elements.modalCanvas.width, elements.modalCanvas.height);
}
